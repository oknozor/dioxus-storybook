use crate::ui::view::shared::{FullscreenButtonProps, GridButtonProps, OutlineButtonProps, ResetZoomButtonProps, ThemeToggleButtonProps, ZoomInButtonProps, ZoomOutButtonProps};
